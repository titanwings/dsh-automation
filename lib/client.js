...
function AutomationView({
  ...
  const [taskView, setTaskView] = (0, import_react3.useState)("all");
  const [rangeView, setRangeView] = (0, import_react3.useState)("list");
  const [calendarCursor, setCalendarCursor] = (0, import_react3.useState)();
  ...
  const todayStart = (0, import_react3.useMemo)(() => startOfLocalDay(now), [now]);
  const todayAutomations = (0, import_react3.useMemo)(() => automations.filter((automation) => automation.nextRunAt !== void 0 && isSameLocalDay(new Date(automation.nextRunAt), todayStart)), [automations, todayStart]);
  const calendarAnchor = calendarCursor ?? startOfLocalWeek(todayStart);
  const pickedDate = selectedDate ?? todayStart;
  const weekDays = (0, import_react3.useMemo)(() => buildWeekCalendarDays(calendarAnchor), [calendarAnchor]);
  const monthDays = (0, import_react3.useMemo)(() => buildMonthCalendarGrid(calendarAnchor), [calendarAnchor]);
  const visibleAutomations = (0, import_react3.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-shell", "data-conversation-composer-overlay": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("header", { className: "dsh-automation-header", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-header-row", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-header-box", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-header-title", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-automation-header-divider", "aria-hidden": "true" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: t("header.subtitle") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-button dsh-automation-button--primary", type: "button", onClick: toggleCreate, children: showCreate ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PauseIcon, {}),
        t("header.closeCreate")
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PlusIcon, { width: 20, height: 20 }),
        t("header.create")
      ] }) })
    ] }) }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-content", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dsh-automation-main-column", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-status-toolbar", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-view-switch", role: "group", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: taskView === "today" ? "is-selected" : "", "aria-pressed": taskView === "today", onClick: () => setTaskView("today"), children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("view.todayTasks") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: todayAutomations.length })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: taskView === "all" ? "is-selected" : "", "aria-pressed": taskView === "all", onClick: () => setTaskView("all"), children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("view.allTasks") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: automations.length })
            ] })
          ] }),
          taskView === "all" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-range-switch", role: "group", "aria-label": t("view.allTasks"), children: ["list", "week", "month"].map((range) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: rangeView === range ? "is-selected" : "", "aria-pressed": rangeView === range, onClick: () => selectRange(range), children: t(`view.${range}`) }, range)) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-status-summary", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: stats?.active ?? 0 }),
              t("stats.active")
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: (stats?.total ?? 0) - (stats?.active ?? 0) }),
              t("stats.paused")
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dsh-automation-next-run", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: t("stats.next") }),
            stats?.nextRunAt === void 0 ? t("stats.noneScheduled") : formatRelativeTime(stats.nextRunAt, now, t)
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-section-heading dsh-automation-module-head", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-section-title", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { children: t("section.automations") }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "dsh-automation-section-scope", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("code", { title: snapshot.scope.cwd, children: snapshot.scope.cwd })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "dsh-automation-section-hint", children: t("section.automationsHint") })
          ] }),
        ...
        taskView === "all" && rangeView !== "list" && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-calendar", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-cal-nav", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-cal-nav-btn", type: "button", "aria-label": "prev", onClick: () => moveCalendar(-1), children: "\u25C0" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-cal-nav-btn", type: "button", onClick: goCalendarToday, children: t("view.today") }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-cal-nav-btn", type: "button", "aria-label": "next", onClick: () => moveCalendar(1), children: "\u25B6" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { className: "dsh-automation-cal-title", children: rangeView === "week" ? t("calendar.weekTitle", { year: calendarAnchor.getFullYear(), month: calendarAnchor.getMonth() + 1, day: calendarAnchor.getDate() }) : t("calendar.monthTitle", { year: calendarAnchor.getFullYear(), month: calendarAnchor.getMonth() + 1 }) })
          ] }),
          rangeView === "week" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-cal-week", children: weekDays.map((day) => {
            const count = countAutomationsOnDay(automations, day);
            const weekday = day.getDay() === 0 ? 7 : day.getDay();
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: `dsh-automation-cal-day${isSameLocalDay(day, todayStart) ? " is-today" : ""}${isSameLocalDay(day, pickedDate) ? " is-selected" : ""}`, onClick: () => selectDay(day), children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-automation-cal-weekday", children: t(`day.${weekday}`) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dsh-automation-cal-date", children: [
                day.getMonth() + 1,
                "/",
                day.getDate()
              ] }),
              count > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-automation-cal-count", children: t("calendar.taskCount", { count }) })
            ] }, day.toISOString());
          }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-cal-month", children: monthDays.map((day) => {
            const count = countAutomationsOnDay(automations, day);
            const otherMonth = day.getMonth() !== calendarAnchor.getMonth();
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: `dsh-automation-cal-month-day${otherMonth ? " is-other" : ""}${isSameLocalDay(day, todayStart) ? " is-today" : ""}${isSameLocalDay(day, pickedDate) ? " is-selected" : ""}`, onClick: () => selectDay(day), children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-automation-cal-month-date", children: day.getDate() }),
              count > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dsh-automation-cal-count dsh-automation-cal-count--dot", children: count })
            ] }, day.toISOString());
          }) })
        ] }),
        ...
        ] }) : visibleAutomations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dsh-automation-empty", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CalendarIcon, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { children: taskView === "today" ? t("view.todayTasks") : t("calendar.emptyDay") }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: taskView === "today" ? t("view.noToday") : t("calendar.emptyDay") }),
          taskView === "today" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => setTaskView("all"), children: t("view.allTasks") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { className: "dsh-automation-button dsh-automation-button--ghost", type: "button", onClick: () => selectRange("list"), children: t("view.list") })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-card-list", children: visibleAutomations.map((automation) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          AutomationCard,
          {
            automation,
            now,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { className: "dsh-automation-runs-column", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dsh-automation-section-heading dsh-automation-module-head", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
...
var en = {
  ...
  "calendar.weekTitle": "Week of {year}/{month}/{day}",
...
var zh = {
  ...
  "calendar.weekTitle": "{year}/{month}/{day} \u5468",
...
.dsh-automation-header{display:flex;width:100%;margin:0 auto 14px;padding-bottom:12px;border-bottom:1px solid var(--dsw-alias-border-l2)}
...
.dsh-automation-header-title{display:flex;flex:none;min-width:0;align-items:center;gap:10px}
...
.dsh-automation-header-box p{flex:none;min-width:0;margin:0;color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px;white-space:nowrap}
...
.dsh-automation-header-divider{width:1px;height:16px;flex:none;background:var(--dsw-alias-border-l2)}
...
.dsh-automation-status-toolbar{display:flex;max-width:none;align-items:center;flex-wrap:wrap;gap:8px 10px;margin:0 0 14px;padding:10px 12px;border:1px solid var(--dsw-alias-border-l2);border-radius:12px;background:var(--dsw-alias-bg-layer-2)}
.dsh-automation-view-switch,.dsh-automation-range-switch{display:inline-flex;align-items:center;gap:3px;padding:3px;border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-base)}
.dsh-automation-view-switch button{display:inline-flex;height:30px;align-items:center;gap:7px;padding:0 11px;border:0;border-radius:7px;background:transparent;color:var(--dsw-alias-label-secondary);font:600 12px/18px var(--dsw-font-family,system-ui);cursor:pointer;white-space:nowrap}
...
.dsh-automation-range-switch button{height:26px;padding:0 10px;border:0;border-radius:7px;background:transparent;color:var(--dsw-alias-label-secondary);font:600 11px/16px var(--dsw-font-family,system-ui);cursor:pointer;white-space:nowrap}
...
.dsh-automation-status-summary{display:inline-flex;align-items:center;gap:14px;margin-left:2px;color:var(--dsw-alias-label-secondary);font-size:11px;line-height:16px;white-space:nowrap}
.dsh-automation-status-summary span{display:inline-flex;align-items:baseline;gap:5px}
.dsh-automation-status-summary b{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:650}
...
.dsh-automation-cal-nav-btn{display:inline-flex;height:28px;align-items:center;justify-content:center;padding:0 10px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);font:600 12px/18px var(--dsw-font-family,system-ui);cursor:pointer}
...
@media(max-width:1100px){.dsh-automation-header{grid-template-columns:1fr}.dsh-automation-header-row{grid-column:1}.dsh-automation-content{grid-template-columns:1fr}.dsh-automation-main-column{border-right:0;padding-right:0}.dsh-automation-runs-column{position:static;margin-top:18px;padding-left:0;border-top:1px solid var(--dsw-alias-border-l2)}.dsh-automation-run-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.dsh-automation-run:nth-child(odd){border-right:1px solid var(--dsw-alias-border-l2)}.dsh-automation-run:nth-last-child(-n+2){border-bottom:0}}
@media(max-width:760px){.dsh-automation-shell{padding:18px 14px calc(var(--dsh-composer-height,152px) + 24px)}.dsh-automation-header{align-items:center}.dsh-automation-header-box p,.dsh-automation-header-divider{display:none}.dsh-automation-header-box{padding:9px 14px;border-radius:12px}.dsh-automation-stats{grid-template-columns:1fr 1fr}.dsh-automation-form-grid,.dsh-automation-schedule-fields,.dsh-automation-permission-grid{grid-template-columns:1fr}.dsh-automation-segmented{width:100%;grid-template-columns:1fr 1fr}.dsh-automation-card-times{grid-template-columns:1fr}.dsh-automation-card-times>div{padding-right:0;border-right:0}.dsh-automation-run-list{grid-template-columns:1fr}.dsh-automation-run:nth-child(odd){border-right:0}.dsh-automation-run:nth-last-child(2){border-bottom:1px solid var(--dsw-alias-border-l2)}}
