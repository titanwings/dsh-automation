...
.dsh-automation-status-toolbar .dsh-automation-cal-month{display:block;max-width:min(720px,100%);margin:0 auto}
.dsh-automation-status-toolbar .dsh-automation-cal-month-weekdays{gap:5px;margin-bottom:5px}
.dsh-automation-status-toolbar .dsh-automation-cal-month-weekdays span{font-size:10px;line-height:14px}
.dsh-automation-status-toolbar .dsh-automation-cal-month-grid{gap:5px}
.dsh-automation-status-toolbar .dsh-automation-cal-month-day{min-height:56px;gap:4px;padding:6px 2px;border-radius:8px}
