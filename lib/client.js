...
.dsh-automation-sidebar-tooltip{box-sizing:border-box;position:fixed;z-index:9999;transform:translateY(-50%);max-width:240px;padding:4px 8px;border-radius:6px;background:#17171a;color:#fff;font-family:var(--dsw-font-family,system-ui);font-size:12px;line-height:18px;white-space:nowrap;box-shadow:0 4px 12px rgba(0,0,0,.35);pointer-events:none}
